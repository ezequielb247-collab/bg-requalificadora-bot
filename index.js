...
async function carregarValores() {
  if (typeof sheets.getValores === "function") {
    try {
      ...
      return {
        ...
        revisao_kit_3_cartao: normalizarNumero(valores.revisao_kit_3_cartao, 350),
        revisao_kit_3_vista: normalizarNumero(valores.revisao_kit_3_vista, 320),
        revisao_kit_5_cartao: normalizarNumero(valores.revisao_kit_5_cartao, 500),
        revisao_kit_5_vista: normalizarNumero(valores.revisao_kit_5_vista, 470),
  ...
  return {
    ...
    revisao_kit_3_cartao: 350,
    revisao_kit_3_vista: 320,
    revisao_kit_5_cartao: 500,
    revisao_kit_5_vista: 470,
